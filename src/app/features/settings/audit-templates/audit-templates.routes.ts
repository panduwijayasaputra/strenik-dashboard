...
export const AUDIT_TEMPLATES_ROUTES: Routes = [
  ...
  { path: 'new', data: { breadcrumb: 'New Template' }, loadComponent: () => import('./components/audit-template-form/audit-template-form.component').then(m => m.AuditTemplateFormComponent) },
];
